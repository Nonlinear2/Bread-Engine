...
TUNEABLE(r_1, int, 164, 0, 500, 30, 0.002);
TUNEABLE(r_2, int, 279, -100, 1000, 50, 0.002);
TUNEABLE(rfp_1, int, 159, 0, 500, 30, 0.002);
TUNEABLE(rfp_2, int, 50, 0, 1000, 10, 0.002);
TUNEABLE(rfp_3, int, 53, 0, 1000, 10, 0.002);
TUNEABLE(rfp_4, int, 144, -100, 1000, 25, 0.002);
TUNEABLE(nmp_1, int, 84, -50, 250, 15, 0.002);
TUNEABLE(nmp_2, int, 24, -300, 300, 5, 0.002);
TUNEABLE(lmp_1, int, 117, -100, 500, 22, 0.002);
TUNEABLE(see_1, int, 89, -100, 1000, 15, 0.002);
...
TUNEABLE(cont_1, int, 945, 0, 3000, 150, 0.002);
TUNEABLE(cont_2, int, 131, 0, 1500, 25, 0.002);
TUNEABLE(qs_fp_1, int, 1681, 0, 3000, 300, 0.002);
TUNEABLE(qs_see_1, int, 286, 0, 900, 50, 0.002);
TUNEABLE(qs_p_1, int, 1029, 0, 5000, 200, 0.002);
TUNEABLE(cthis_1, int, 8479, 0, 16000, 1000, 0.002);
TUNEABLE(cthis_2, int, 578, 0, 3000, 100, 0.002);
TUNEABLE(qs_p_idx, int, 7, 0, 20, 0.5, 0.002);
TUNEABLE(his_1, int, 28, 0, 300, 5, 0.002);
TUNEABLE(his_2, int, 26, 0, 300, 5, 0.002);
TUNEABLE(his_3, int, 1003, 0, 5000, 200, 0.002);
TUNEABLE(asp_1, int, 100, 0, 5000, 20, 0.002);
TUNEABLE(asp_2, int, 341, 0, 5000, 60, 0.002);
TUNEABLE(red_1, int, 1231, 0, 10000, 200, 0.002);
TUNEABLE(red_2, int, 1834, 0, 10000, 250, 0.002);
TUNEABLE(red_3, int, 723, 0, 10000, 150, 0.002);
