...
TUNEABLE(r_1, int, 152, 0, 10000, 40, 0.002);
TUNEABLE(r_2, int, 286, 0, 10000, 50, 0.002);
TUNEABLE(rfp_1, int, 109, 0, 10000, 25, 0.002);
TUNEABLE(rfp_2, int, 36, 0, 10000, 6, 0.002);
TUNEABLE(rfp_3, int, 32, 0, 10000, 12, 0.002);
TUNEABLE(rfp_4, int, 59, -100, 10000, 20, 0.002);
TUNEABLE(rfp_5, int, 30, 0, 10000, 6, 0.002);
TUNEABLE(rfp_6, int, 335, 0, 10000, 70, 0.002);
TUNEABLE(nmp_1, int, 81, -50, 10000, 20, 0.002);
TUNEABLE(nmp_2, int, 23, -300, 10000, 5, 0.002);
TUNEABLE(nmp_3, int, 150, 0, 10000, 30, 0.002);
TUNEABLE(sprob_1, int, 422, 0, 10000, 70, 0.002);
TUNEABLE(lmp_1, int, 72, -100, 1000, 20, 0.002);
TUNEABLE(see_1, int, 53, -100, 1000, 20, 0.002);
...
TUNEABLE(cont_2, int, 93, 0, 1500, 20, 0.002);
TUNEABLE(cont_3, int, 32, 0, 1500, 6, 0.002);
TUNEABLE(cont_4, int, 28, 0, 1500, 6, 0.002);
TUNEABLE(cont_5, int, 264, 0, 3000, 100, 0.002);
TUNEABLE(qs_fp_1, int, 2212, 0, 3000, 400, 0.002);
TUNEABLE(qs_see_1, int, 357, 0, 1000, 50, 0.002);
TUNEABLE(qs_p_1, int, 1295, 0, 5000, 200, 0.002);
TUNEABLE(cthis_1, int, 7633, 0, 30000, 1500, 0.002);
TUNEABLE(cthis_2, int, 678, 0, 3000, 100, 0.002);
TUNEABLE(qs_p_idx, int, 8, 0, 20, 0.5, 0.002);
TUNEABLE(asp_1, int, 61, 0, 5000, 20, 0.002);
TUNEABLE(asp_2, int, 443, 0, 5000, 80, 0.002);
TUNEABLE(red_1, int, 1023, 0, 10000, 250, 0.002);
TUNEABLE(red_2, int, 1113, 0, 10000, 250, 0.002);
...
TUNEABLE(red_6, int, 674, 0, 10000, 200, 0.002);
TUNEABLE(red_7, int, 702, 0, 10000, 180, 0.002);
TUNEABLE(ext_1, int, 25, 0, 10000, 10, 0.002);
...
TUNEABLE(corr_1, int, 310, 0, 10000, 50, 0.002);
TUNEABLE(corr_2, int, 230, 0, 10000, 40, 0.002);
...
TUNEABLE(de_1, int, 66, 0, 10000, 18, 0.002);
