...
UNACTIVE_TUNEABLE(cont_3, int, 30, 0, 1500, 6, 0.002);
UNACTIVE_TUNEABLE(cont_4, int, 30, 0, 1500, 6, 0.002);
UNACTIVE_TUNEABLE(cont_5, int, 500, 0, 3000, 100, 0.002);
...
UNACTIVE_TUNEABLE(corr_1, int, 100, 0, 10000, 20, 0.002);
UNACTIVE_TUNEABLE(corr_2, int, 650, 0, 10000, 130, 0.002);
