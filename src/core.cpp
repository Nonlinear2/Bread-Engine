...
TUNEABLE(r_1, int, 134, 0, 10000, 40, 0.002);
TUNEABLE(r_2, int, 200, 0, 10000, 50, 0.002);
TUNEABLE(rfp_1, int, 143, 0, 10000, 25, 0.002);
TUNEABLE(rfp_2, int, 27, 0, 10000, 6, 0.002);
TUNEABLE(rfp_3, int, 13, 0, 10000, 12, 0.002);
TUNEABLE(rfp_4, int, 60, -100, 10000, 20, 0.002);
TUNEABLE(rfp_5, int, 31, 0, 10000, 6, 0.002);
TUNEABLE(rfp_6, int, 305, 0, 10000, 70, 0.002);
TUNEABLE(nmp_1, int, 74, -50, 10000, 20, 0.002);
TUNEABLE(nmp_2, int, 21, -300, 10000, 5, 0.002);
TUNEABLE(nmp_3, int, 137, 0, 10000, 30, 0.002);
TUNEABLE(sprob_1, int, 528, 0, 10000, 70, 0.002);
TUNEABLE(lmp_1, int, 51, -100, 1000, 20, 0.002);
TUNEABLE(see_1, int, 24, -100, 1000, 20, 0.002);
TUNEABLE(see_2, int, 11, 0, 100, 0.5, 0.002);
TUNEABLE(se_1, int, 8, -100, 100, 0.5, 0.002);
TUNEABLE(se_2, int, 2, -100, 100, 0.5, 0.002);
TUNEABLE(lmr_1, int, 10, 0, 23, 0.5, 0.002);
TUNEABLE(cont_1, int, 704, 0, 10000, 200, 0.002);
TUNEABLE(cont_2, int, 66, 0, 1500, 20, 0.002);
TUNEABLE(cont_3, int, 30, 0, 1500, 6, 0.002);
TUNEABLE(cont_4, int, 30, 0, 1500, 6, 0.002);
TUNEABLE(cont_5, int, 181, 0, 3000, 100, 0.002);
TUNEABLE(qs_fp_1, int, 2314, 0, 3000, 400, 0.002);
TUNEABLE(qs_see_1, int, 284, 0, 1000, 50, 0.002);
TUNEABLE(qs_p_1, int, 1258, 0, 5000, 200, 0.002);
TUNEABLE(cthis_1, int, 8390, 0, 30000, 1500, 0.002);
TUNEABLE(cthis_2, int, 905, 0, 3000, 100, 0.002);
TUNEABLE(qs_p_idx, int, 7, 0, 20, 0.5, 0.002);
TUNEABLE(asp_1, int, 87, 0, 5000, 20, 0.002);
TUNEABLE(asp_2, int, 519, 0, 5000, 80, 0.002);
TUNEABLE(red_1, int, 852, 0, 10000, 250, 0.002);
TUNEABLE(red_2, int, 1482, 0, 10000, 250, 0.002);
TUNEABLE(red_3, int, 1959, 0, 10000, 300, 0.002);
TUNEABLE(red_4, int, 465, 0, 10000, 150, 0.002);
TUNEABLE(red_5, int, 1658, 0, 10000, 300, 0.002);
TUNEABLE(red_6, int, 434, 0, 10000, 200, 0.002);
TUNEABLE(red_7, int, 701, 0, 10000, 180, 0.002);
TUNEABLE(ext_1, int, 46, 0, 10000, 10, 0.002);
TUNEABLE(ext_2, int, 80, 0, 10000, 16, 0.002);
TUNEABLE(ext_3, int, 14, 0, 10000, 3, 0.002);
TUNEABLE(red_th_1, int, 1877, 0, 10000, 320, 0.002);
TUNEABLE(red_th_2, int, 1532, 0, 10000, 450, 0.002);
TUNEABLE(corr_1, int, 396, 0, 10000, 50, 0.002);
TUNEABLE(corr_2, int, 253, 0, 10000, 40, 0.002);
TUNEABLE(corr_3, int, 193, 0, 10000, 40, 0.002);
TUNEABLE(corr_4, int, 142, 0, 10000, 40, 0.002);
TUNEABLE(corr_5, int, 165, 0, 10000, 40, 0.002);
TUNEABLE(corr_6, int, 351, 0, 10000, 130, 0.002);
TUNEABLE(de_1, int, 76, 0, 10000, 18, 0.002);
