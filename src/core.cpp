...
TUNEABLE(r_1, int, 199, 0, 1000, 40, 0.002);
TUNEABLE(r_2, int, 258, -100, 1000, 50, 0.002);
TUNEABLE(rfp_1, int, 128, 0, 1000, 25, 0.002);
TUNEABLE(rfp_2, int, 36, 0, 1000, 6, 0.002);
TUNEABLE(rfp_3, int, 66, 0, 1000, 12, 0.002);
TUNEABLE(rfp_4, int, 105, -100, 1000, 20, 0.002);
TUNEABLE(nmp_1, int, 107, -50, 1000, 20, 0.002);
TUNEABLE(nmp_2, int, 28, -300, 1000, 5, 0.002);
TUNEABLE(lmp_1, int, 98, -100, 1000, 20, 0.002);
TUNEABLE(see_1, int, 90, -100, 1000, 20, 0.002);
...
TUNEABLE(corr_1, int, 273, 0, 10000, 50, 0.002);
