...
TUNEABLE(r_1, int, 180, 0, 10000, 40, 0.002);
TUNEABLE(r_2, int, 272, 0, 10000, 50, 0.002);
TUNEABLE(rfp_1, int, 114, 0, 10000, 25, 0.002);
TUNEABLE(rfp_2, int, 39, 0, 10000, 6, 0.002);
TUNEABLE(rfp_3, int, 39, 0, 10000, 12, 0.002);
TUNEABLE(rfp_4, int, 72, -100, 10000, 20, 0.002);
TUNEABLE(rfp_5, int, 341, 0, 10000, 70, 0.002);
TUNEABLE(nmp_1, int, 76, -50, 10000, 20, 0.002);
TUNEABLE(nmp_2, int, 25, -300, 10000, 5, 0.002);
TUNEABLE(sprob_1, int, 350, 0, 10000, 70, 0.002);
...
TUNEABLE(red_2, int, 1024, 0, 10000, 250, 0.002);
TUNEABLE(red_3, int, 1742, 0, 10000, 300, 0.002);
TUNEABLE(red_4, int, 815, 0, 10000, 150, 0.002);
TUNEABLE(red_5, int, 1998, 0, 10000, 300, 0.002);
TUNEABLE(red_6, int, 788, 0, 10000, 200, 0.002);
TUNEABLE(red_7, int, 746, 0, 10000, 180, 0.002);
TUNEABLE(red_th_1, int, 1600, 0, 10000, 320, 0.002);
TUNEABLE(red_th_2, int, 2135, 0, 10000, 450, 0.002);
TUNEABLE(corr_1, int, 268, 0, 10000, 50, 0.002);
TUNEABLE(corr_2, int, 200, 0, 10000, 40, 0.002);
TUNEABLE(corr_3, int, 200, 0, 10000, 40, 0.002);
TUNEABLE(corr_4, int, 200, 0, 10000, 40, 0.002);
TUNEABLE(corr_5, int, 200, 0, 10000, 40, 0.002);
TUNEABLE(corr_6, int, 592, 0, 10000, 130, 0.002);
TUNEABLE(de_1, int, 90, 0, 10000, 18, 0.002);
