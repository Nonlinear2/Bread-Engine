...
UNACTIVE_TUNEABLE(q_att_1, int, 93, 0, 500, 20, 0.002);
UNACTIVE_TUNEABLE(q_att_2, int, 96, 0, 500, 20, 0.002);
UNACTIVE_TUNEABLE(c_chk_1, int, 165, 0, 1000, 25, 0.002);
UNACTIVE_TUNEABLE(q_chk_1, int, 112, 0, 1000, 25, 0.002);
UNACTIVE_TUNEABLE(c_cpt, int, 282, 0, 1000, 60, 0.002);
UNACTIVE_TUNEABLE(c_prm, int, 172, 0, 1000, 40, 0.002);
UNACTIVE_TUNEABLE(q_prm, int, 150, 0, 1000, 30, 0.002);
UNACTIVE_TUNEABLE(q_kil, int, 125, 0, 1000, 25, 0.002);
UNACTIVE_TUNEABLE(q_his, int, 176, 0, 1000, 30, 0.002);
UNACTIVE_TUNEABLE(q_cthis, int, 138, 0, 1000, 30, 0.002);
UNACTIVE_TUNEABLE(bst, int, 196, 0, 1500, 40, 0.002);
UNACTIVE_TUNEABLE(his_1, int, 33, 0, 300, 5, 0.002);
UNACTIVE_TUNEABLE(his_2, int, 32, 0, 300, 5, 0.002);
UNACTIVE_TUNEABLE(his_3, int, 1069, 0, 5000, 200, 0.002);
UNACTIVE_TUNEABLE(his_4, int, 19, 0, 300, 3, 0.002);
UNACTIVE_TUNEABLE(his_5, int, 16, 0, 300, 3, 0.002);
UNACTIVE_TUNEABLE(his_6, int, 549, 0, 5000, 110, 0.002);
UNACTIVE_TUNEABLE(chis_1, int, 35, 0, 300, 5, 0.002);
UNACTIVE_TUNEABLE(chis_2, int, 36, 0, 300, 5, 0.002);
UNACTIVE_TUNEABLE(chis_3, int, 1098, 0, 5000, 200, 0.002);
UNACTIVE_TUNEABLE(chis_4, int, 18, 0, 300, 3, 0.002);
UNACTIVE_TUNEABLE(chis_5, int, 15, 0, 300, 3, 0.002);
UNACTIVE_TUNEABLE(chis_6, int, 383, 0, 5000, 110, 0.002);
UNACTIVE_TUNEABLE(cphis, int, 205, 0, 5000, 41, 0.002);
