...
TUNEABLE(psm_1, int, 100, 0, 1000, 20, 0.002);
TUNEABLE(psm_2, int, 100, 0, 1000, 20, 0.002);
TUNEABLE(att_1, int, 48, 0, 500, 10, 0.002);
TUNEABLE(att_2, int, 49, 0, 500, 10, 0.002);
TUNEABLE(chk_1, int, 160, 0, 1000, 20, 0.002);
TUNEABLE(cpt, int, 119, 0, 1000, 20, 0.002);
TUNEABLE(prm, int, 119, 0, 1000, 20, 0.002);
TUNEABLE(kil, int, 149, 0, 1000, 25, 0.002);
TUNEABLE(his, int, 100, 0, 1000, 20, 0.002);
TUNEABLE(chis, int, 100, 0, 1000, 20, 0.002);
