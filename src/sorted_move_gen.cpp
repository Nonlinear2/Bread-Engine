...
TUNEABLE(q_att_1, int, 54, 0, 500, 10, 0.002);
TUNEABLE(q_att_2, int, 50, 0, 500, 10, 0.002);
TUNEABLE(c_chk_1, int, 165, 0, 1000, 25, 0.002);
TUNEABLE(q_chk_1, int, 125, 0, 1000, 25, 0.002);
TUNEABLE(c_cpt, int, 169, 0, 1000, 25, 0.002);
TUNEABLE(c_prm, int, 111, 0, 1000, 20, 0.002);
TUNEABLE(q_prm, int, 85, 0, 1000, 20, 0.002);
TUNEABLE(q_kil, int, 136, 0, 1000, 25, 0.002);
TUNEABLE(q_his, int, 180, 0, 1000, 25, 0.002);
TUNEABLE(q_cthis, int, 176, 0, 1000, 25, 0.002);
...
TUNEABLE(cphis, int, 255, 0, 5000, 60, 0.002);
