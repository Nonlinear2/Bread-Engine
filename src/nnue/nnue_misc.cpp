...
vec_int8 NNUE_UTILS::crelu32_to_8(vec_int32 in_1, vec_int32 in_2, vec_int32 in_3, vec_int32 in_4, vec_int8 zero){
    ...
    return permute4x64_epi64<0b01'11'00'10>(out);
}

vec_int8 NNUE_UTILS::crelu16_to_8(vec_int16 in_1, vec_int16 in_2){
    // packs sets negative values to 0 and saturates at 255, which effectively applies relu
    vec_int8 out = packus_epi16(in_1, in_2);
    return permute4x64_epi64<0b11'01'10'00>(out); // undo the packus shuffle
}

vec_int16 NNUE_UTILS::crelu16_to_16(vec_int16 in, vec_int16 zero, vec_int16 qscale){
    return min_epi16(qscale, max_epi16(in, zero));
}
