...
TUNEABLE(CONTHIST_FILL_VALUE, int, 0, -5'000, 5'000, 50, 0.002);
TUNEABLE(HIST_FILL_VALUE, int, 0, -5'000, 5'000, 50, 0.002);
TUNEABLE(CAPTHIST_FILL_VALUE, int, 0, -5'000, 5'000, 50, 0.002);
TUNEABLE(MAX_CAPTHIST_BONUS, int, 10'000, 0, 10'000, 2000, 0.002);
TUNEABLE(PAWN_CORRHIST_FILL_VALUE, int, 0, -5'000, 5'000, 50, 0.002);
TUNEABLE(MAX_CONTHIST_BONUS, int, 10'000, 0, 10'000, 2000, 0.002);
TUNEABLE(MAX_HIST_BONUS, int, 10'000, 0, 10'000, 2000, 0.002);
TUNEABLE(MAX_PAWN_CORRHIST_BONUS, int, 10'000, 0, 10'000, 2000, 0.002);
