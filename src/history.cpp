...
TUNEABLE(CONTHIST_FILL_VALUE, int, 3, -5'000, 5'000, 50, 0.002);
TUNEABLE(HIST_FILL_VALUE, int, 6, -5'000, 5'000, 50, 0.002);

TUNEABLE(MAX_CONTHIST_BONUS, int, 9900, 0, 50'000, 2000, 0.002);
TUNEABLE(MAX_HIST_BONUS, int, 9900, 0, 50'000, 2000, 0.002);
